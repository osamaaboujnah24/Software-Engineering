...
class MessageManager {
    ...
    public function getManagedProjects() {
        try {
            ...
            error_log("getManagedProjects error: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function sendMessageToTeam($projectId, $message) {
        try {
            ...
            error_log("sendMessageToTeam error: " . $e->getMessage());
            return "حدث خطأ   .";
        }
    }
    ...
    public function getSentMessages($projectIds) {
        try {
            ...
            error_log("getSentMessages error: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function getReceivedMessages($projectIds) {
        try {
            ...
            error_log("getReceivedMessages error: " . $e->getMessage());
            return [];
        }
    }
}
